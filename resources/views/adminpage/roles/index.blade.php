    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.roles.create') }}" class="btn btn-primary btn-sm ms-auto"><i class="bi bi-plus-lg"></i> Tambah Role</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.roles.destroy', $role->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus?')">
                                    @csrf
                                    @method('DELETE')
